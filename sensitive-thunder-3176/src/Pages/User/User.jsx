    ...
    <div>
      <Box marginTop={150}>
        ...
        >
          <Flex>
            {" "}
            <FiUserPlus className={styles.user} />{" "}
            <Text marginTop="auto" color="#88a9f9" marginLeft="10px">
              You can now invite guests like clients, vendors, or contractors.
              You can add them free of charge
            </Text>
            <a
              href=""
              target="_blank"
        ...
        <Box className={styles.userBox}>
          ...
          <Box marginTop="30px" className={styles.back}>
            <Flex>
              <input
                type="checkbox"
              ...
              <Button className={styles.back}>
                <BiEdit className={styles.back} />
              </Button>
              <Button className={styles.back}>
                <BsPlusLg className={styles.back} />
              </Button>
            </Flex>
          </Box>
            ...
            {user.map((user) => {
              return (
                <Flex>
                  ...
                  <Text marginLeft={10} marginTop="auto" marginBottom="auto">
                    {user.email}
                  </Text>
                  <Box className={styles.bgchange}>
                    <Button marginLeft={10} className={styles.accountbtn}>
                      <BiEdit fontSize={20} />
                    </Button>
                    <Button marginLeft={5} className={styles.accountbtn}>
        ...
        <Flex>
          ...
          <Button bg="#4bb063" marginTop="20px" marginLeft={5} color="white">
            Apply
          </Button>
        </Flex>
      </Box>
